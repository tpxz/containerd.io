...
See [`docs/containerd-2.0.md`](containerd-2.0.md).
...
* [for ops and admins](ops.md)
* [namespaces](namespaces.md)
* [client options](client-opts.md)

To get started contributing to containerd, see [CONTRIBUTING](CONTRIBUTING.md).

If you are interested in trying out containerd see our example at [Getting Started](getting-started.md).
...
The current required version of `runc` is described in [RUNC.md](RUNC.md).
...
your system. See more details in [Checkpoint and Restore](features.md#checkpoint-and-restore).
...
For configuring registries, see [registry host configuration documentation](hosts.md)

## Features

For a detailed overview of containerd's core concepts and the features it supports,
please refer to the [FEATURES.MD](features.md) document.
...
* [For Non-Ansible Users, Preforming a Custom Installation Using the Release Tarball and Kubeadm](getting-started.md)
* [CRI Plugin Testing Guide](cri/testing.md)
* [Debugging Pods, Containers, and Images with `crictl`](cri/crictl.md)
* [Configuring `cri` Plugins](cri/config.md)
